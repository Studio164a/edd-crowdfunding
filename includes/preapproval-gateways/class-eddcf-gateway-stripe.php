<?php
/**
 * The class that provides the Stripe integration.
 *
 * @class 		EDDCF_Gateway_Stripe
 * @version		1.0.0
 * @package		EDD Crowdfunding/Classes/EDDCF_Gateway_Stripe
...
if ( ! class_exists( 'EDDCF_Gateway_Stripe' ) ) : 

/**
 * EDDCF_Gateway_Stripe
 *
 * @since 		1.0.0
 */
class EDDCF_Gateway_Stripe implements EDDCF_Preapproval_Gateway {
	...
	public function process_payment( $payment_id, EDDCF_Campaign $campaign ) {
		return edds_charge_preapproved( $payment_id );
	}
